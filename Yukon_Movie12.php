...
<head>
  ...
  <title>Heidi | Top Latest Movies</title>
        ...
        <div class="row gy-4 justify-content-center">
          ...
          <div class="col-lg-5 content">
            ...
            <div class="row">
              <div class="col-lg-6">
                <ul>
                  <li><i class="bi bi-chevron-right"></i> <strong>Director:</strong> <span>Allan Dwan</span></li>
                
                  <li><i class="bi bi-chevron-right"></i> <strong>Popularity:</strong> <span>100</span></li>
              ...
              <div class="col-lg-6">
                <ul>
                  <li><i class="bi bi-chevron-right"></i> <strong>Type:</strong> <span>Drama</span></li>
				  <li><i class="bi bi-chevron-right"></i> <strong>Rating:</strong> <span>Passed</span></li>
                </ul>
              </div>
            </div>
            ...
            <p class="m-0">
			<h4>Synopsis</h4>
A plucky little orphan girl gets dumped abruptly into her gruff, hermit grandfather's care, then later gets retaken and delivered as a companion for an injured girl.            </p>
          </div>
        </div>
...
function getMovies() {
    ...
    $sql = "SELECT m_id, m_name FROM movies WHERE m_id=13";
