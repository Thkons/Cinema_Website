...
<head>
  ...
  <title>The Mortuary Collection | Coming Soon | Yukon Cinemas</title>
      ...
      <div class="container">
        ...
        <div class="row gy-4 justify-content-center">
          ...
          <div class="col-lg-5 content">
		      <h2>The Mortuary Collection</h2>
            
           
            <div class="row">
              <div class="col-lg-6">
                <ul>
                  <li><i class="bi bi-chevron-right"></i> <strong>Director:</strong> <span>Ryan Spindell</span></li>
                
                  <li><i class="bi bi-chevron-right"></i> <strong>Popularity:</strong> <span>39</span></li>
				                    <li><i class="bi bi-chevron-right"></i> <strong>Duration:</strong> <span>1h 48m</span></li>
              ...
              <div class="col-lg-6">
                <ul>
                  <li><i class="bi bi-chevron-right"></i> <strong>Type:</strong> <span>Fantasy</span></li>
				  <li><i class="bi bi-chevron-right"></i> <strong>Rating:</strong> <span>R</span></li>
				  <li><i class="bi bi-chevron-right"></i> <strong>Release Date:</strong> <span>18/03/2019</span></li>
                </ul>
              </div>
            </div>
            ...
            <p class="py-3">
			<h4>Cast</h4>
        Tristan Byon, Eden Campbell, Hannah R. Loyd

            </p>
            <p class="m-0">
			<h4>Synopsis</h4>
An eccentric mortician recounts several macabre and phantasmagorical tales that he's encountered in his distinguished career.       </p>
<p class="m-0">
			Soon With Us    </p>
          </div>
        </div>
