...
<head>
  ...
  <title>Harry Potter and the Sorcerer's Stone | Top Latest Movies</title>
        ...
        <div class="row gy-4 justify-content-center">
          ...
          <div class="col-lg-5 content">
            ...
            <div class="row">
              <div class="col-lg-6">
                <ul>
                  <li><i class="bi bi-chevron-right"></i> <strong>Director:</strong> <span>Chris Columbus</span></li>
                
                  <li><i class="bi bi-chevron-right"></i> <strong>Popularity:</strong> <span>65</span></li>
				                    <li><i class="bi bi-chevron-right"></i> <strong>Duration:</strong> <span>2h 35m</span></li>
              ...
              <div class="col-lg-6">
                <ul>
                  <li><i class="bi bi-chevron-right"></i> <strong>Type:</strong> <span>Adventure</span></li>
				  <li><i class="bi bi-chevron-right"></i> <strong>Rating:</strong> <span>PG</span></li>
            ...
            <p class="py-3">
			<h4>Cast</h4>
             Daniel Radcliffe, Rupert Grint, Richard Harris, Maggie Smith, Robbie Coltrane, Saunders Triplets, Fiona Shaw, Harry Melling
          </p>
...
function getMovies() { //παίρνω το όνομα και το id των ταινιών που έχω στην βάση
    global $conn; // Assuming $conn is your database connection

    $sql = "SELECT m_id, m_name FROM movies WHERE m_id=1";
...
function getCinemas() { //παίρνω το όνομα και το id των cinema που έχω στην βάση
    global $conn; // Assuming $conn is your database connection
