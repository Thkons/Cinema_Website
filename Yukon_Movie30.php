...
<head>
  ...
  <title>Togo | Coming Soon | Yukon Cinemas</title>
...
<body style="background: radial-gradient(circle at center top, rgb(103, 55, 40) 0px, rgb(5, 17, 34) 900px, rgb(5, 17, 34));overflow: unset;">
  ...
  <main id="main" data-aos="fade" data-aos-delay="1500">
        ...
        <div class="row gy-4 justify-content-center">
          ...
          <div class="col-lg-5 content">
            ...
            <div class="row">
              <div class="col-lg-6">
                <ul>
                  <li><i class="bi bi-chevron-right"></i> <strong>Director:</strong> <span>Ericson Core</span></li>
                
                  <li><i class="bi bi-chevron-right"></i> <strong>Popularity:</strong> <span>3.245</span></li>
              ...
              <div class="col-lg-6">
                <ul>
				  ...
				  <li><i class="bi bi-chevron-right"></i> <strong>Release Date:</strong> <span>23/05/2019</span></li>
                </ul>
              </div>
            </div>
    ...
    Willem Dafoe, Julianne Nicholson, Christopher Heyerdahl
            ...
            <p class="m-0">
			<h4>Synopsis</h4>
The story of Togo, the sled dog who led the 1925 serum run despite being considered too small and weak to lead such an intense race.      </p>
<p class="m-0">
			Soon With Us    </p>
          </div>
        </div>
