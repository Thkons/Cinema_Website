...
<head>
  ...
  <title>The Goonies | Coming Soon | Yukon Cinemas</title>
...
<body style="background: radial-gradient(circle at center top, rgb(103, 55, 40) 0px, rgb(5, 17, 34) 900px, rgb(5, 17, 34));overflow: unset;">
  ...
  <main id="main" data-aos="fade" data-aos-delay="1500">
        ...
        <div class="row gy-4 justify-content-center">
          ...
          <div class="col-lg-5 content">
            ...
            <div class="row">
              <div class="col-lg-6">
                <ul>
                  <li><i class="bi bi-chevron-right"></i> <strong>Director:</strong> <span>Richard Donner</span></li>
                
                  <li><i class="bi bi-chevron-right"></i> <strong>Popularity:</strong> <span>156</span></li>
				                    <li><i class="bi bi-chevron-right"></i> <strong>Duration:</strong> <span>1h 54m</span></li>
              ...
              <div class="col-lg-6">
                <ul>
				  ...
				  <li><i class="bi bi-chevron-right"></i> <strong>Release Date:</strong> <span>20/10/1985</span></li>
                </ul>
              </div>
            </div>
    ...
    Sean Astin, Josh Brolin, Jeff Cohen
            ...
            <p class="m-0">
			<h4>Synopsis</h4>
A group of young misfits called The Goonies discover an ancient map and set out on an adventure to find a legendary pirate's long-lost treasure.       </p>
<p class="m-0">
			Soon With Us    </p>
          </div>
        </div>
