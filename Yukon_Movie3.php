...
<head>
  ...
  <title>The Last Of Us | Top Latest Movies</title>
        ...
        <div class="row gy-4 justify-content-center">
          ...
          <div class="col-lg-5 content">
            ...
            <div class="row">
              <div class="col-lg-6">
                <ul>
                  <li><i class="bi bi-chevron-right"></i> <strong>Director:</strong> <span>Neil Druckmann</span></li>
                
                  <li><i class="bi bi-chevron-right"></i> <strong>Popularity:</strong> <span>83</span></li>
                                   <li><i class="bi bi-chevron-right"></i> <strong>Duration:</strong> <span>50m</span></li>
...
function getMovies() {
    ...
    $sql = "SELECT m_id, m_name FROM movies WHERE m_id=3";
