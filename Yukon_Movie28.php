...
<head>
  ...
  <title>Pacific Rim | Coming Soon | Yukon Cinemas</title>
...
<body style="background: radial-gradient(circle at center top, rgb(103, 55, 40) 0px, rgb(5, 17, 34) 900px, rgb(5, 17, 34));overflow: unset;">
  ...
  <main id="main" data-aos="fade" data-aos-delay="1500">
        ...
        <div class="row gy-4 justify-content-center">
          ...
          <div class="col-lg-5 content">
            ...
            <div class="row">
              <div class="col-lg-6">
                <ul>
                  <li><i class="bi bi-chevron-right"></i> <strong>Director:</strong> <span>Guillermo del Toro</span></li>
                
                  <li><i class="bi bi-chevron-right"></i> <strong>Popularity:</strong> <span>1.296</span></li>
				                    <li><i class="bi bi-chevron-right"></i> <strong>Duration:</strong> <span>2h 11m</span></li>
              ...
              <div class="col-lg-6">
                <ul>
                  <li><i class="bi bi-chevron-right"></i> <strong>Type:</strong> <span>Action</span></li>
				  <li><i class="bi bi-chevron-right"></i> <strong>Rating:</strong> <span>PG-13</span></li>
				  <li><i class="bi bi-chevron-right"></i> <strong>Release Date:</strong> <span>04/08/2013</span></li>
                </ul>
              </div>
            </div>
    ...
    Idris Elba, Charlie Hunnam, Rinko Kikuchi
            ...
            <p class="m-0">
			<h4>Synopsis</h4>
As a war between humankind and monstrous sea creatures wages on, a former pilot and a trainee are paired up to drive a seemingly obsolete special weapon in a desperate effort to save the world from the apocalypse.       </p>
<p class="m-0">
			Soon With Us    </p>
          </div>
        </div>
