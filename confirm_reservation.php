...
<head>
  ...
  <title>Confirmation Of Reservation | Yukon Cinemas</title>
...
$time = $_POST["time"];
    ...
    // Insert the selected seats into the database and mark them as reserved
    foreach ($selectedSeats as $seat) {
        // Validate seat number if needed
        $sql = "INSERT INTO reservations (movie_id, cinema_id, reservation_date, reservation_time, seat_number, user_name, user_email, status) 
                VALUES ('$movie', '$cinema', '$reservation_date', '$time', '$seat', '$user_name', '$user_email', '$status')";
    ...
    echo "<div style='text-align:center;'><br><br><br><br>Reservation confirmed! <br> Thank you <br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br></div>";
}
