...
<head>
  ...
  <title>Jurassic World | Coming Soon | Yukon Cinemas</title>
...
<body style="background: radial-gradient(circle at center top, rgb(103, 55, 40) 0px, rgb(5, 17, 34) 900px, rgb(5, 17, 34));overflow: unset;">
  ...
  <main id="main" data-aos="fade" data-aos-delay="1500">
        ...
        <div class="row gy-4 justify-content-center">
          ...
          <div class="col-lg-5 content">
            ...
            <div class="row">
              <div class="col-lg-6">
                <ul>
                  <li><i class="bi bi-chevron-right"></i> <strong>Director:</strong> <span>Colin Trevorrow</span></li>
                
                  <li><i class="bi bi-chevron-right"></i> <strong>Popularity:</strong> <span>918</span></li>
				                    <li><i class="bi bi-chevron-right"></i> <strong>Duration:</strong> <span>2h 4m</span></li>
              ...
              <div class="col-lg-6">
                <ul>
				  ...
				  <li><i class="bi bi-chevron-right"></i> <strong>Release Date:</strong> <span>11/8/2015</span></li>
                </ul>
              </div>
            </div>
    ...
    Chris Pratt, Bryce Dallas Howard, Ty Simpkins
            ...
            <p class="m-0">
			<h4>Synopsis</h4>
A new theme park, built on the original site of Jurassic Park, creates a genetically modified hybrid dinosaur, the Indominus Rex, which escapes containment and goes on a killing spree.         </p>
<p class="m-0">
			Soon With Us    </p>
          </div>
        </div>
