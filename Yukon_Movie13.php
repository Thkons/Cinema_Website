...
<head>
  ...
  <title>Joker | Top Latest Movies</title>
        ...
        <div class="row gy-4 justify-content-center">
          ...
          <div class="col-lg-5 content">
            ...
            <div class="row">
              <div class="col-lg-6">
                <ul>
                  <li><i class="bi bi-chevron-right"></i> <strong>Director:</strong> <span>Todd Phillips</span></li>
                
                  <li><i class="bi bi-chevron-right"></i> <strong>Popularity:</strong> <span>171</span></li>
...
function getMovies() {
    ...
    $sql = "SELECT m_id, m_name FROM movies WHERE m_id=14";
