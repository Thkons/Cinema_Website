...
<head>
  ...
  <title>Blair Witch | Coming Soon | Yukon Cinemas</title>
...
<body style="background: radial-gradient(circle at center top, rgb(103, 55, 40) 0px, rgb(5, 17, 34) 900px, rgb(5, 17, 34));overflow: unset;">
  ...
  <main id="main" data-aos="fade" data-aos-delay="1500">
            ...
            <div class="row">
              <div class="col-lg-6">
                <ul>
                  ...
                  <li><i class="bi bi-chevron-right"></i> <strong>Popularity:</strong> <span>12</span></li>
				                    <li><i class="bi bi-chevron-right"></i> <strong>Duration:</strong> <span>1h 29m</span></li>
              ...
              <div class="col-lg-6">
                <ul>
				  ...
				  <li><i class="bi bi-chevron-right"></i> <strong>Release Date:</strong> <span>09/10/2016</span></li>
                </ul>
              </div>
            </div>
    ...
    James Allen McCune, Callie Hernandez, Corbin Reid
            ...
            <p class="m-0">
			<h4>Synopsis</h4>
After discovering a video showing what he believes to be his vanished sister Heather, James and a group of friends head to the forest believed to be inhabited by the Blair Witch.         </p>
<p class="m-0">
			Soon With Us    </p>
          </div>
        </div>
