...
<head>
  ...
  <title>The Godfather | Top Latest Movies</title>
...
<body style="background: radial-gradient(circle at center top, rgb(103, 55, 40) 0px, rgb(5, 17, 34) 900px, rgb(5, 17, 34));overflow: unset;">
  ...
  <main id="main" data-aos="fade" data-aos-delay="1500">
            ...
            <div class="row">
              <div class="col-lg-6">
                <ul>
                  ...
                  <li><i class="bi bi-chevron-right"></i> <strong>Popularity:</strong> <span>64</span></li>
				                    <li><i class="bi bi-chevron-right"></i> <strong>Duration:</strong> <span>2h 55m</span></li>
    ...
    Marlon Brando, Al Pacino, James Caan
            ...
            <p class="m-0">
			<h4>Synopsis</h4>
Don Vito Corleone, head of a mafia family, decides to hand over his empire to his youngest son Michael. However, his decision unintentionally puts the lives of his loved ones in grave danger.            </p>
          </div>
        </div>
...
function getMovies() {
    ...
    $sql = "SELECT m_id, m_name FROM movies WHERE m_id=7";
