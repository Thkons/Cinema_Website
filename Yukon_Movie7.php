...
<head>
  ...
  <title>Pink Floyd: The Wall | Top Latest Movies</title>
      ...
      <div class="container">
        ...
        <div class="row gy-4 justify-content-center">
          ...
          <div class="col-lg-5 content">
            <h2>Pink Floyd: The Wall</h2>
           
            <div class="row">
              <div class="col-lg-6">
                <ul>
                  <li><i class="bi bi-chevron-right"></i> <strong>Director:</strong> <span>Alan Parker</span></li>
                
                  <li><i class="bi bi-chevron-right"></i> <strong>Popularity:</strong> <span>3.602</span></li>
				                    <li><i class="bi bi-chevron-right"></i> <strong>Duration:</strong> <span>1h 35m</span></li>
            ...
            <p class="m-0">
			<h4>Synopsis</h4>
A confined but troubled rock star descends into madness in the midst of his physical and social isolation from everyone.            </p>
          </div>
        </div>
...
function getMovies() {
    ...
    $sql = "SELECT m_id, m_name FROM movies WHERE m_id=8";
