...
<head>
  ...
  <title>The Boy Behind the Door | Top Latest Movies</title>
      ...
      <div class="container">
        ...
        <div class="row gy-4 justify-content-center">
          ...
          <div class="col-lg-5 content">
            <h2>The Boy Behind the Door</h2>
           
            <div class="row">
              <div class="col-lg-6">
                <ul>
                  <li><i class="bi bi-chevron-right"></i> <strong>Director:</strong> <span>David Charbonier</span></li>
                
                  <li><i class="bi bi-chevron-right"></i> <strong>Popularity:</strong> <span>48</span></li>
				                    <li><i class="bi bi-chevron-right"></i> <strong>Duration:</strong> <span>1h 28m</span></li>
            ...
            <p class="m-0">
			<h4>Synopsis</h4>
After Bobby and his best friend Kevin are kidnapped and taken to a strange house in the middle of nowhere, Bobby manages to escape. But then he hears Kevin's screams for help and realizes he can't leave his friend behind.            </p>
          </div>
        </div>
...
function getMovies() {
    ...
    $sql = "SELECT m_id, m_name FROM movies WHERE m_id=6";
