...
<head>
  ...
  <title>Killers of the Flower Moon | Top Latest Movies</title>
        ...
        <div class="row gy-4 justify-content-center">
          ...
          <div class="col-lg-5 content">
            ...
            <div class="row">
              <div class="col-lg-6">
                <ul>
                  <li><i class="bi bi-chevron-right"></i> <strong>Director:</strong> <span>Martin Scorsese</span></li>
                
                  <li><i class="bi bi-chevron-right"></i> <strong>Popularity:</strong> <span>14</span></li>
				                    <li><i class="bi bi-chevron-right"></i> <strong>Duration:</strong> <span>3h 26m</span></li>
            ...
            <p class="m-0">
			<h4>Synopsis</h4>
When oil is discovered in 1920s Oklahoma under Osage Nation land, the Osage people are murdered one by one - until the FBI steps in to unravel the mystery.            </p>
          </div>
        </div>
...
function getMovies() {
    ...
    $sql = "SELECT m_id, m_name FROM movies WHERE m_id=12";
