...
<head>
  ...
  <title>The Breach | Coming Soon | Yukon Cinemas</title>
        ...
        <div class="row gy-4 justify-content-center">
          ...
          <div class="col-lg-5 content">
            ...
            <div class="row">
              <div class="col-lg-6">
                <ul>
                  <li><i class="bi bi-chevron-right"></i> <strong>Director:</strong> <span>Rodrigo Gudiño</span></li>
                
                  <li><i class="bi bi-chevron-right"></i> <strong>Popularity:</strong> <span>43</span></li>
				                    <li><i class="bi bi-chevron-right"></i> <strong>Duration:</strong> <span>1h 32m</span></li>
              ...
              <div class="col-lg-6">
                <ul>
                  <li><i class="bi bi-chevron-right"></i> <strong>Type:</strong> <span>Horror</span></li>
				  <li><i class="bi bi-chevron-right"></i> <strong>Rating:</strong> <span>R</span></li>
				  <li><i class="bi bi-chevron-right"></i> <strong>Release Date:</strong> <span>09/10/2022</span></li>
                </ul>
              </div>
            </div>
            ...
            <p class="py-3">
			<h4>Cast</h4>
    Allan Hawco, Emily Alatalo, Natalie Brown

            </p>
            <p class="m-0">
			<h4>Synopsis</h4>
Counting down his last days as Chief of Police in the tiny town of Lone Crow, John Hawkins must investigate one last case when a mangled body with uncanny wounds washes up on the shores of the Porcupine River.        </p>
<p class="m-0">
			Soon With Us    </p>
          </div>
        </div>
