...
<head>
  ...
  <title>All American | Top Latest Movies</title>
        ...
        <div class="row gy-4 justify-content-center">
          ...
          <div class="col-lg-5 content">
            ...
            <div class="row">
              <div class="col-lg-6">
                <ul>
                  <li><i class="bi bi-chevron-right"></i> <strong>Director:</strong> <span>April Blair</span></li>
                
                  <li><i class="bi bi-chevron-right"></i> <strong>Popularity:</strong> <span>932</span></li>
                  <li><i class="bi bi-chevron-right"></i> <strong>Duration:</strong> <span>45m</span></li>
              ...
              <div class="col-lg-6">
                <ul>
				  ...
				  <li><i class="bi bi-chevron-right"></i> <strong>Rating:</strong> <span>TV-14</span></li>
                </ul>
              </div>
            </div>
            ...
            <p class="py-3">
			<h4>Cast</h4>
                Daniel EzraSamantha, LoganMichael, Evans Behling
...
function getMovies() {
    ...
    $sql = "SELECT m_id, m_name FROM movies WHERE m_id=2";
